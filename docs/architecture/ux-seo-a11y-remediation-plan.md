...
- **RL-010 not kept**: the "Data Flow" → "Data Flow" copy rename was applied and then reverted during this session, keeping "Data Flow" as the on-screen name. ADR-0012 item 6's rationale for the rename stands unresolved — see "Deferred."
